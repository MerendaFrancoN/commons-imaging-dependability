...
\begin{enumerate}
    ...
    \item \textbf{Files with Lower Coverage Rates (Below 50\%):}
    \begin{itemize}
        \item \texttt{ColorTools.java}
        \item \texttt{PixelDensity.java}
        \item \texttt{AbstractImageParser.java}
        \item \texttt{ImagingRuntimeException.java}
        \item \texttt{ImagingFormatException.java}
        \item \texttt{ImagingParameters.java}
    \end{itemize}
